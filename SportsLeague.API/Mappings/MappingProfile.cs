...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        // --- Mappings para Sponsor ---
        CreateMap<SponsorRequestDTO, Sponsor>();
        CreateMap<Sponsor, SponsorResponseDTO>();

        // --- Mappings para TournamentSponsor (La relación) ---
        CreateMap<TournamentSponsor, TournamentSponsorResponseDTO>();

        // Aquí le decimos que saque el nombre desde la relación
        CreateMap<TournamentSponsor, TournamentSponsorResponseDTO>()
        ...
        CreateMap<Match, MatchResponseDTO>()
            ...
            .ForMember(dest => dest.RefereeFullName,
                opt => opt.MapFrom(src =>
                    src.Referee.FirstName + " " + src.Referee.LastName)); // concatenar nombre y apellido
